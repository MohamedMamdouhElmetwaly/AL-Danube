...
export default function Home() {
  ...
  return <main className="map-app">
    ...
    <aside id="model-sidebar" className="placement-panel panel" aria-label="Model placement controls" hidden={!sidebarOpen}>
      ...
      <div className="model-content"><div className="model-summary"><span className="model-icon"><Box size={30} strokeWidth={1.4}/></span><div><b>market_al_danube</b><span>3D model · Default placement</span></div></div>
      ...
      <p className="placement-note">Model resets to default position on every page load. Changes are temporary for this session only.</p>
